<%@ Page  Language="C#" MasterPageFile="~/TPPD.Master" AutoEventWireup="true"  CodeBehind="C_ForleaveOverTime_rpt1.aspx.cs" Inherits="TPPDDB._3_forleave.C_ForleaveOverTime_rpt1" %>
                ...
                <asp:Table runat="server" Width="100%">
                    ...
                    <asp:TableRow>
                        ...
                        <asp:TableCell style="text-align: left; white-space:nowrap;">
                            <asp:TextBox runat="server" ID="txt_Year" MaxLength="5" Width="40px"></asp:TextBox>
                        </asp:TableCell>
                    </asp:TableRow>
                    <asp:TableRow>
                        <asp:TableCell CssClass="ViewHeader">
                ...
                <table width="100%">
                    <tr>
                        <td style="text-align: center;">
                            <asp:Button runat="server" ID="btn_allrpt2" Text="列印"  OnClick="btn_monthrpt2_Click" />
                            <input type="reset" value="取消" />
                            <asp:Button runat="server" ID="btn_allrpt2_1" Text="列印Excel"  OnClick="btn_monthrpt2_1_Click" />
                           <%-- <asp:Button runat="server" ID="btn_monthrpt1" Text="業務加班補發月清冊" CssClass="style9" OnClick="btn_monthrpt1_Click"/>
                            <asp:Button runat="server" ID="btn_monthrpt1_1" Text="業務加班補發月清冊(Excel)" CssClass="style9" OnClick="btn_monthrpt1_1_Click" />
                            <asp:Button runat="server" ID="btn_monthrpt2" Text="超勤加班補發月清冊" CssClass="style9" OnClick="btn_monthrpt2_Click" />
                            <asp:Button runat="server" ID="btn_monthrpt2_1" Text="超勤加班補發月清冊(Excel)" CssClass="style9" OnClick="btn_monthrpt2_1_Click" />--%>
                        </td>
                    </tr>
                </table>
            </asp:Panel>
