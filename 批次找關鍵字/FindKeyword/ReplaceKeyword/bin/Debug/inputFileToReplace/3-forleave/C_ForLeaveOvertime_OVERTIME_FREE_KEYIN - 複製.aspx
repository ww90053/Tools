            ...
            <ContentTemplate>
                <asp:Panel ID="Panel3" runat="server">
                    ...
                    <table class="style6" border="1">
                        <tr>
                            ...
                            <td class="style3">
                                ...
                                &nbsp;&nbsp;
                                <asp:TextBox ID="TextBox_DUTYDATE" runat="server" MaxLength="7" Width="65px"></asp:TextBox>
                                ...
                                <asp:Button ID="btnJobRelocationConfrm" runat="server" Visible="false" 
                                    Text="確認" onclick="btnJobRelocationConfrm_Click" />
                            ...
                            <td class="style3">
                                <asp:Panel ID="Panel2" runat="server">
                                    <table id="lstTimes" style="border-style: solid; border-width: 1px; padding: 1px 4px; width: 100%;">
                                        <tr>
                                            <td>
                                                06:<asp:TextBox ID="TextBox_DUTYITEM1_1" runat="server" Width="15px" MaxLength="2"></asp:TextBox>-07:<asp:TextBox
                                            ...
                                            <td>
                                                07:<asp:TextBox ID="TextBox_DUTYITEM2_1" runat="server" Width="15px" MaxLength="2"></asp:TextBox>-08:<asp:TextBox
                                            ...
                                            <td>
                                                08:<asp:TextBox ID="TextBox_DUTYITEM3_1" runat="server" Width="15px" MaxLength="2"></asp:TextBox>-09:<asp:TextBox
                                            ...
                                            <td>
                                                09:<asp:TextBox ID="TextBox_DUTYITEM4_1" runat="server" Width="15px" MaxLength="2"></asp:TextBox>-10:<asp:TextBox
                                        ...
                                        <tr>
                                            <td>
                                                10:<asp:TextBox ID="TextBox_DUTYITEM5_1" runat="server" Width="15px" MaxLength="2"></asp:TextBox>-11:<asp:TextBox
                                            ...
                                            <td>
                                                11:<asp:TextBox ID="TextBox_DUTYITEM6_1" runat="server" Width="15px" MaxLength="2"></asp:TextBox>-12:<asp:TextBox
                                            ...
                                            <td>
                                                12:<asp:TextBox ID="TextBox_DUTYITEM7_1" runat="server" Width="15px" MaxLength="2"></asp:TextBox>-13:<asp:TextBox
                                            ...
                                            <td>
                                                13:<asp:TextBox ID="TextBox_DUTYITEM8_1" runat="server" Width="15px" MaxLength="2"></asp:TextBox>-14:<asp:TextBox
                                        ...
                                        <tr>
                                            <td>
                                                14:<asp:TextBox ID="TextBox_DUTYITEM9_1" runat="server" Width="15px" MaxLength="2"></asp:TextBox>-15:<asp:TextBox
                                            ...
                                            <td>
                                                15:<asp:TextBox ID="TextBox_DUTYITEM10_1" runat="server" Width="15px" MaxLength="2"></asp:TextBox>-16:<asp:TextBox
                                            ...
                                            <td>
                                                16:<asp:TextBox ID="TextBox_DUTYITEM11_1" runat="server" Width="15px" MaxLength="2"></asp:TextBox>-17:<asp:TextBox
                                            ...
                                            <td>
                                                17:<asp:TextBox ID="TextBox_DUTYITEM12_1" runat="server" Width="15px" MaxLength="2"></asp:TextBox>-18:<asp:TextBox
                                        ...
                                        <tr>
                                            <td>
                                                18:<asp:TextBox ID="TextBox_DUTYITEM13_1" runat="server" Width="15px" MaxLength="2"></asp:TextBox>-19:<asp:TextBox
                                            ...
                                            <td>
                                                19:<asp:TextBox ID="TextBox_DUTYITEM14_1" runat="server" Width="15px" MaxLength="2"></asp:TextBox>-20:<asp:TextBox
                                            ...
                                            <td>
                                                20:<asp:TextBox ID="TextBox_DUTYITEM15_1" runat="server" Width="15px" MaxLength="2"></asp:TextBox>-21:<asp:TextBox
                                            ...
                                            <td>
                                                21:<asp:TextBox ID="TextBox_DUTYITEM16_1" runat="server" Width="15px" MaxLength="2"></asp:TextBox>-22:<asp:TextBox
                                        ...
                                        <tr>
                                            <td>
                                                22:<asp:TextBox ID="TextBox_DUTYITEM17_1" runat="server" Width="15px" MaxLength="2"></asp:TextBox>-23:<asp:TextBox
                                            ...
                                            <td>
                                                23:<asp:TextBox ID="TextBox_DUTYITEM18_1" runat="server" Width="15px" MaxLength="2"></asp:TextBox>-24:<asp:TextBox
                                            ...
                                            <td>
                                                24:<asp:TextBox ID="TextBox_DUTYITEM19_1" runat="server" Width="15px" MaxLength="2"></asp:TextBox>-01:<asp:TextBox
                                            ...
                                            <td>
                                                01:<asp:TextBox ID="TextBox_DUTYITEM20_1" runat="server" Width="15px" MaxLength="2"></asp:TextBox>-02:<asp:TextBox
                                        ...
                                        <tr>
                                            <td>
                                                02:<asp:TextBox ID="TextBox_DUTYITEM21_1" runat="server" Width="15px" MaxLength="2"></asp:TextBox>-03:<asp:TextBox
                                            ...
                                            <td>
                                                03:<asp:TextBox ID="TextBox_DUTYITEM22_1" runat="server" Width="15px" MaxLength="2"></asp:TextBox>-04:<asp:TextBox
                                            ...
                                            <td>
                                                04:<asp:TextBox ID="TextBox_DUTYITEM23_1" runat="server" Width="15px" MaxLength="2"></asp:TextBox>-05:<asp:TextBox
                                            ...
                                            <td>
                                                05:<asp:TextBox ID="TextBox_DUTYITEM24_1" runat="server" Width="15px" MaxLength="2"></asp:TextBox>-06:<asp:TextBox
                                        ...
                                        <tr>
                                            <td>
                                                06:<asp:TextBox ID="TextBox_DUTYITEM25_1" runat="server" Width="15px" MaxLength="2"></asp:TextBox>-07:<asp:TextBox
                                            ...
                                            <td>
                                                07:<asp:TextBox ID="TextBox_DUTYITEM26_1" runat="server" Width="15px" MaxLength="2"></asp:TextBox>-08:<asp:TextBox
                                            ...
                                            <td>
                                                08:<asp:TextBox ID="TextBox_DUTYITEM27_1" runat="server" Width="15px" MaxLength="2"></asp:TextBox>-09:<asp:TextBox
                                            ...
                                            <td>
                                             ...
                                             <td colspan="3" style="color:#0033FF;font-weight:bold;">超勤補休時數 : <asp:TextBox ID="txtConvertRest" runat="server" Width="30px" MaxLength="2"></asp:TextBox></td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <%--<td> 是否停休：</td>--%>
                                            <td colspan = "2">
                                            <div style = "float:left;color:#0033FF;font-weight:bold;">    &nbsp;&nbsp;&nbsp;&nbsp; 停休或實報實銷 :</div> 
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:MSDBConnectionString_toTest %>"
                        ...
                        </SelectParameters>--><!--SelectCommand="SELECT  CDP.MZ_ID , MZ_NAME,  DUTYDATE ,  DUTYITEM1 ,  DUTYITEM2 ,  DUTYITEM3 ,  DUTYITEM4 ,  DUTYITEM5 ,  DUTYITEM6 ,  DUTYITEM7 ,  DUTYITEM8 ,  DUTYITEM9 ,
