<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ForLeaveBasicSearch.aspx.cs"
    Inherits="TPPDDB._3_forleave.ForLeaveBasicSearch" %>
                ...
                <asp:Panel ID="Panel2" runat="server" Width="100%">
                    <table class="style52" border="1" width="100%">
                        ...
                        <tr>
                            ...
                            <td class="style57">
                                <asp:TextBox ID="TextBox_ID" runat="server" AutoPostBack="True" MaxLength="10" Font-Bold="True"
                        ...
                        <tr>
                            <td style="text-align: left">
                                ...
                                <asp:Button ID="bt_DLBASE" runat="server" OnClick="Button_Click" Text="基本資料查詢" class="style53"
                                    Width="135px" Visible="False" />&nbsp;&nbsp;<asp:Button ID="bt_DLTB01" runat="server" Text="請假資料查詢"
