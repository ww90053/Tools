<%@ Page  Language="C#" MasterPageFile="~/TPPD.Master" AutoEventWireup="true"  CodeBehind="C_ForleaveOverTime_rpt.aspx.cs" Inherits="TPPDDB._3_forleave.C_ForleaveOverTime_rpt" %>
                ...
                <table width="100%">
                    <tr>
                        <td style="text-align: center;">
                             <asp:Button runat="server" ID="btn_allrpt2" Text="列印"  OnClick="btn_monthrpt1_Click" />
                            <input type="reset" value="取消" />
                            <asp:Button runat="server" ID="btn_allrpt2_1" Text="列印Excel"  OnClick="btn_monthrpt1_1_Click" />
