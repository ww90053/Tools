<%@ Page  Language="C#" MasterPageFile="~/TPPD.Master" AutoEventWireup="true"  CodeBehind="C_ForleaveOverTime_allrpt1.aspx.cs" Inherits="TPPDDB._3_forleave.C_ForleaveOverTime_allrpt1" %>
                    ...
                    <tr>
                        <td style="text-align: center;">
                           <%-- <asp:Button runat="server" ID="btn_allrpt1" Text="業務加班補發總清冊" CssClass="style9" OnClick="btn_allrpt1_Click"/>
                            ...
                            <asp:Button runat="server" ID="btn_allrpt2" Text="列印"  OnClick="btn_allrpt2_Click" />
                            <input type="reset" value="取消" />
                            <asp:Button runat="server" ID="btn_allrpt2_1" Text="列印Excel"  OnClick="btn_allrpt2_1_Click" />
                        </td>
                    </tr>
                </table>
             </asp:Panel>
