<%@ Page Title="" Language="C#" MasterPageFile="~/TPPD.Master" AutoEventWireup="true" CodeBehind="C_ForLeaveBasic_New.aspx.cs" Inherits="TPPDDB._3_forleave.C_ForLeaveBasic_New" %>
                ...
                <table class="style6" border="1">
                    <tr>
                        ...
                        <td class="style2">
                            ...
                            <%--遮罩後的身分證號--%>
                            <asp:TextBox ID="TextBox_MZ_ID_Masked" runat="server" Width="100px" ReadOnly="True" Visible="false"></asp:TextBox>
                        </td>
                        <td class="style75">
                            姓 名
                        </td>
                        <td class="style3">
                            ...
                            <asp:TextBox ID="TextBox_MZ_NAME" runat="server" Width="100px" ReadOnly="True"></asp:TextBox>
                             <%--遮罩後的--%>
                            <asp:TextBox ID="TextBox_MZ_NAME_Masked" runat="server" Width="100px" ReadOnly="True" Visible="false"></asp:TextBox>
                        </td>
                    </tr>
                </table>
                <table class="style6" border="1">
                ...
                <asp:View ID="View1" runat="server">
                    <asp:Panel ID="Panel2" runat="server" Height="330px">
                        ...
                        <table id="tableLastYearJobLocation" runat="server" visible="false" class="style6" border="1">
                            <tr>
                                <td class="style68"  bgcolor="#FFFF66">最近一年工作職掌</td>
                                <td class="style3">
                        ...
                        <table class="style6" border="1">
                            <tr>
                                ...
                                <td class="style3">
                                    <%-- 2021/03/26  請假事由  字數限制 50 變 100--%>
                                    <asp:TextBox ID="TextBox_MZ_CAUSE" runat="server" Width="715px" MaxLength="100"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
                        <table class="style6" border="1">
                    ...
                    <tr>
                        <td>
                            ...
                            <asp:Button ID="btOK" runat="server" meta:resourcekey="btOKResource1" OnClick="btOK_Click"
                                Text="確定" Enabled="False" class="style9" AccessKey="s" OnClientClick="return confirm(&quot;請再重新檢視請假起迄日、時數、代理人等資料，是否確認完成？&quot;)"/>
                            ...
                            <asp:Button ID="btOK2" runat="server" Text="確定修改 不重跑線上流程" class="style9" OnClick="btOK2_Click"
