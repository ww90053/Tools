...
namespace TPPDDB._3_forleave.report {
    ...
    public class C_monthturns_IDNO : ReportClass {
        
        public C_monthturns_IDNO() {
        }
        
        public override string ResourceName {
            get {
                return "C_monthturns_IDNO.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "TPPDDB.3-forleave.report.C_monthturns_IDNO.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedC_monthturns_IDNO : Component, ICachedReport {
        
        public CachedC_monthturns_IDNO() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            C_monthturns_IDNO rpt = new C_monthturns_IDNO();
            rpt.Site = this.Site;
            return rpt;
        }
