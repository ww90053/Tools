...
namespace TPPDDB._3_forleave.report {
    ...
    public class C_overtimelist : ReportClass {
        
        public C_overtimelist() {
        }
        
        public override string ResourceName {
            get {
                return "C_overtimelist.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "TPPDDB.3-forleave.report.C_overtimelist.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedC_overtimelist : Component, ICachedReport {
        
        public CachedC_overtimelist() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            C_overtimelist rpt = new C_overtimelist();
            rpt.Site = this.Site;
            return rpt;
        }
