...
namespace TPPDDB._3_forleave.report {
    ...
    public class C_noplaylist : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "TPPDDB.3-forleave.report.C_noplaylist.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedC_noplaylist : Component, ICachedReport {
        
        public CachedC_noplaylist() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            C_noplaylist rpt = new C_noplaylist();
            rpt.Site = this.Site;
            return rpt;
        }
