...
namespace TPPDDB._3_forleave.report {
    ...
    public class C_codecount : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "TPPDDB.3-forleave.report.C_codecount.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedC_codecount : Component, ICachedReport {
        
        public CachedC_codecount() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            C_codecount rpt = new C_codecount();
            rpt.Site = this.Site;
            return rpt;
        }
