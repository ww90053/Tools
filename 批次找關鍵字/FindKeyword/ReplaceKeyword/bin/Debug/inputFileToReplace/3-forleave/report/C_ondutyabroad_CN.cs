...
namespace TPPDDB._3_forleave.report {
    ...
    public class C_ondutyabroad_CN : ReportClass {
        
        public C_ondutyabroad_CN() {
        }
        
        public override string ResourceName {
            get {
                return "C_ondutyabroad_CN.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "TPPDDB.3-forleave.report.C_ondutyabroad_CN.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedC_ondutyabroad_CN : Component, ICachedReport {
        
        public CachedC_ondutyabroad_CN() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            C_ondutyabroad_CN rpt = new C_ondutyabroad_CN();
            rpt.Site = this.Site;
            return rpt;
        }
