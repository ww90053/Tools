...
namespace TPPDDB._3_forleave.report {
    ...
    public class C_day_detail : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "TPPDDB.3-forleave.report.C_day_detail.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedC_day_detail : Component, ICachedReport {
        
        public CachedC_day_detail() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            C_day_detail rpt = new C_day_detail();
            rpt.Site = this.Site;
            return rpt;
        }
