...
namespace TPPDDB._3_forleave.report {
    ...
    public class C_over_detail : ReportClass {
        
        public C_over_detail() {
        }
        
        public override string ResourceName {
            get {
                return "C_over_detail.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "TPPDDB.3-forleave.report.C_over_detail.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedC_over_detail : Component, ICachedReport {
        
        public CachedC_over_detail() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            C_over_detail rpt = new C_over_detail();
            rpt.Site = this.Site;
            return rpt;
        }
