...
namespace TPPDDB._3_forleave.report {
    ...
    public class C_ONDUTY_PAY_LIST : ReportClass {
        
        public C_ONDUTY_PAY_LIST() {
        }
        
        public override string ResourceName {
            get {
                return "C_ONDUTY_PAY_LIST.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "TPPDDB.3-forleave.report.C_ONDUTY_PAY_LIST.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedC_ONDUTY_PAY_LIST : Component, ICachedReport {
        
        public CachedC_ONDUTY_PAY_LIST() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            C_ONDUTY_PAY_LIST rpt = new C_ONDUTY_PAY_LIST();
            rpt.Site = this.Site;
            return rpt;
        }
