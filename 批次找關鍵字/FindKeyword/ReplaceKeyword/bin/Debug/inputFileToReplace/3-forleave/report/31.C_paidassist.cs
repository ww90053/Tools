...
namespace TPPDDB._3_forleave.report {
    ...
    public class Crystal_Report131C_paidassist : ReportClass {
        
        public Crystal_Report131C_paidassist() {
        }
        
        public override string ResourceName {
            get {
                return "31.C_paidassist.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "TPPDDB.3-forleave.report.31.C_paidassist.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedCrystal_Report131C_paidassist : Component, ICachedReport {
        
        public CachedCrystal_Report131C_paidassist() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            Crystal_Report131C_paidassist rpt = new Crystal_Report131C_paidassist();
            rpt.Site = this.Site;
            return rpt;
        }
