...
namespace TPPDDB._3_forleave.report {
    ...
    public class C_ToBeOffDuty : ReportClass {
        
        public C_ToBeOffDuty() {
        }
        
        public override string ResourceName {
            get {
                return "C_ToBeOffDuty.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "TPPDDB.3-forleave.report.C_ToBeOffDuty.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedC_ToBeOffDuty : Component, ICachedReport {
        
        public CachedC_ToBeOffDuty() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            C_ToBeOffDuty rpt = new C_ToBeOffDuty();
            rpt.Site = this.Site;
            return rpt;
        }
