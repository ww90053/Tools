...
namespace TPPDDB._3_forleave.report {
    ...
    public class C_carddetail : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "TPPDDB.3-forleave.report.C_carddetail.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedC_carddetail : Component, ICachedReport {
        
        public CachedC_carddetail() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            C_carddetail rpt = new C_carddetail();
            rpt.Site = this.Site;
            return rpt;
        }
