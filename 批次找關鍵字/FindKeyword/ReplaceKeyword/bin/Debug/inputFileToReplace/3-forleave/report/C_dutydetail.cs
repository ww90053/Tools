...
namespace TPPDDB._3_forleave.report {
    ...
    public class C_dutydetail : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "TPPDDB.3-forleave.report.C_dutydetail.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedC_dutydetail : Component, ICachedReport {
        
        public CachedC_dutydetail() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            C_dutydetail rpt = new C_dutydetail();
            rpt.Site = this.Site;
            return rpt;
        }
