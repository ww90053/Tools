...
namespace TPPDDB._3_forleave.report {
    ...
    public class C_ondutyabroad : ReportClass {
        
        public C_ondutyabroad() {
        }
        
        public override string ResourceName {
            get {
                return "C_ondutyabroad.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "TPPDDB.3-forleave.report.C_ondutyabroad.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedC_ondutyabroad : Component, ICachedReport {
        
        public CachedC_ondutyabroad() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            C_ondutyabroad rpt = new C_ondutyabroad();
            rpt.Site = this.Site;
            return rpt;
        }
