...
namespace TPPDDB._3_forleave.report {
    ...
    public class C_ondutyour : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "TPPDDB.3-forleave.report.C_ondutyour.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedC_ondutyour : Component, ICachedReport {
        
        public CachedC_ondutyour() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            C_ondutyour rpt = new C_ondutyour();
            rpt.Site = this.Site;
            return rpt;
        }
