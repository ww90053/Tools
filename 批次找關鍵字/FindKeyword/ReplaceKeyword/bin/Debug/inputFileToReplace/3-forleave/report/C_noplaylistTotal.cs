...
namespace TPPDDB._3_forleave.report {
    ...
    public class C_noplaylistTotal : ReportClass {
        
        public C_noplaylistTotal() {
        }
        
        public override string ResourceName {
            get {
                return "C_noplaylistTotal.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "TPPDDB.3-forleave.report.C_noplaylistTotal.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedC_noplaylistTotal : Component, ICachedReport {
        
        public CachedC_noplaylistTotal() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            C_noplaylistTotal rpt = new C_noplaylistTotal();
            rpt.Site = this.Site;
            return rpt;
        }
