...
namespace TPPDDB._3_forleave.report {
    ...
    public class C_abroad_CN : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "TPPDDB.3-forleave.report.C_abroad_CN.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedC_abroad_CN : Component, ICachedReport {
        
        public CachedC_abroad_CN() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            C_abroad_CN rpt = new C_abroad_CN();
            rpt.Site = this.Site;
            return rpt;
        }
