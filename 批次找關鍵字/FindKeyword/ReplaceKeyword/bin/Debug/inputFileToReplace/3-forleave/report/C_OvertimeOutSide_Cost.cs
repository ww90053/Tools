...
namespace TPPDDB._3_forleave.report {
    ...
    public class C_OvertimeOutSide_Cost : ReportClass {
        
        public C_OvertimeOutSide_Cost() {
        }
        
        public override string ResourceName {
            get {
                return "C_OvertimeOutSide_Cost.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "TPPDDB.3-forleave.report.C_OvertimeOutSide_Cost.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedC_OvertimeOutSide_Cost : Component, ICachedReport {
        
        public CachedC_OvertimeOutSide_Cost() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            C_OvertimeOutSide_Cost rpt = new C_OvertimeOutSide_Cost();
            rpt.Site = this.Site;
            return rpt;
        }
