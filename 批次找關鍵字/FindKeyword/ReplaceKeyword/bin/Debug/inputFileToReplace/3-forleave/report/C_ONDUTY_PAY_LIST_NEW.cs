...
namespace TPPDDB._3_forleave.report {
    ...
    public class C_ONDUTY_PAY_LIST_NEW : ReportClass {
        
        public C_ONDUTY_PAY_LIST_NEW() {
        }
        
        public override string ResourceName {
            get {
                return "C_ONDUTY_PAY_LIST_NEW.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "TPPDDB.3-forleave.report.C_ONDUTY_PAY_LIST_NEW.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedC_ONDUTY_PAY_LIST_NEW : Component, ICachedReport {
        
        public CachedC_ONDUTY_PAY_LIST_NEW() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            C_ONDUTY_PAY_LIST_NEW rpt = new C_ONDUTY_PAY_LIST_NEW();
            rpt.Site = this.Site;
            return rpt;
        }
