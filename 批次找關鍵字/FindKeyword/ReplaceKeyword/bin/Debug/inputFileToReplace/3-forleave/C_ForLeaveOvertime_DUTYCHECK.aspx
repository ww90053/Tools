<%@ Page Title="" Language="C#" MasterPageFile="~/TPPD.Master" AutoEventWireup="true"
    CodeBehind="C_ForLeaveOvertime_DUTYCHECK.aspx.cs" Inherits="TPPDDB._3_forleave.C_ForLeaveOvertime_DUTYCHECK" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <asp:Panel ID="Panel1" runat="server">
                <table class="style6" border="1">
                    <tr>
                        ...
                        <td class="style3">
                            <asp:TextBox ID="TextBox_DUTYCHECK_NO" runat="server" Width="50px"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RV_DUTYCHECK_NO" runat="server" ControlToValidate="TextBox_DUTYCHECK_NO"
                    ...
                    <tr>
                        ...
                        <td style="text-align: left">
                            <asp:TextBox ID="TextBox_DUTYCHECK" runat="server" TextMode="MultiLine" Width="683px"
            ...
            <cc1:TBGridView ID="GridView1" runat="server" Width="100%" CellPadding="4" EnableEmptyContentRender="True"
                GridLines="None" AutoGenerateColumns="False" DataKeyNames="DUTYCHECK_NO,MZ_AD,MZ_UNIT"
                ...
                <Columns>
                    <asp:BoundField DataField="DUTYCHECK_NO" HeaderText="盤查點代號" ReadOnly="True"
                        SortExpression="DUTYCHECK_NO">
                        <ItemStyle Width="15%" />
                    </asp:BoundField>
                    <asp:BoundField DataField="DUTYCHECK" HeaderText="盤查地點" SortExpression="DUTYCHECK" />
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:MSDBConnectionString_toTest %>"
                ProviderName="<%$ ConnectionStrings:MSDBConnectionString_toTest.ProviderName %>" SelectCommand="SELECT * FROM C_DUTYCHECK WHERE MZ_AD=@MZ_AD AND MZ_UNIT=@MZ_UNIT ">
                <SelectParameters>
