...
{
    public partial class C_overtimepaystate_cost_rpt : System.Web.UI.Page
    {
        int TPM_FION=0;
        ...
        protected void btPrint_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                //string tmp_url = "C_rpt.aspx?fn=OvertimeOutSide_Cost&TPM_FION=" + TPM_FION +
                //    "&DATE=" + TextBox_MZ_DATE1.Text + "&MZ_AD=" + DropDownList_AD.SelectedItem.Text;
                /// Joy 修改條件 查無資料錯誤
                /// 
                string tmp_url = "C_rpt.aspx?fn=OvertimeOutSide_Cost&TPM_FION=" + TPM_FION +
