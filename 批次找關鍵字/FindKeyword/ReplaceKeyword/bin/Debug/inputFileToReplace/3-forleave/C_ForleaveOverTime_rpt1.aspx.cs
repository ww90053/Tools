...
{
    public partial class C_ForleaveOverTime_rpt1 : System.Web.UI.Page
    {
        string TPM_FION = "";
        /// <summary>
        /// 初始化各頁面功能
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
           ...
           // txt_Year.Text = (DateTime.Today.Year - 1911).ToString() + DateTime.Today.Month.ToString("00");
        }
        ...
        //protected void btn_monthrpt1_Click(object sender, EventArgs e)
        //{
        //    string pdflink1 = System.Configuration.ConfigurationManager.AppSettings["pdflink"].ToString();

        //    string tmp_url = "C_overtime_monthrpt1.aspx?pdf=1&MZ_ID=" + txt_MZ_ID.Text.Trim() + "&PM_FION=" + TPM_FION +
        //             "&Year=" + txt_Year.Text +
        ...
        //protected void btn_monthrpt1_1_Click(object sender, EventArgs e)
        //{
        //    string pdflink1 = System.Configuration.ConfigurationManager.AppSettings["pdflink"].ToString();

        //    string tmp_url = "C_overtime_monthrpt1.aspx?pdf=0&MZ_ID=" + txt_MZ_ID.Text.Trim() + "&PM_FION=" + TPM_FION +
        //             "&Year=" + txt_Year.Text +
        //             "&AD=" + ddl_Search_AD.SelectedValue + "&UNIT=" + ddl_Search_Unit.SelectedValue;
        ////    string filename = "/userfiles/" + DateTime.Now.ToString("yyyyMMddHHmmssff") + ".pdf";
        //    string url = "http://" + Request.ServerVariables["Server_Name"] + ":" + Request.ServerVariables["Server_port"] + "/3-forleave/" + tmp_url;
        ...
        protected void btn_monthrpt2_Click(object sender, EventArgs e)
        {
            string pdflink1 = System.Configuration.ConfigurationManager.AppSettings["pdflink"].ToString();

            string tmp_url = "C_overtime_monthrpt2.aspx?pdf=1&ctype=" + rbl_print.SelectedValue + "&MZ_ID=" + txt_MZ_ID.Text.Trim() + "&PM_FION=" + TPM_FION +
                     "&Year=" + txt_Year.Text +
                     "&AD=" + ddl_Search_AD.SelectedValue + "&UNIT=" + ddl_Search_Unit.SelectedValue;
            ...
            System.Diagnostics.Process.Start(pdflink1, " -s A4 -L 3 -R 3 -T 5 -B 0 -O Landscape  --zoom 1.2   " + url + " " + Server.MapPath(filename));
            System.Threading.Thread.Sleep(15000);
            ScriptManager.RegisterClientScriptBlock(UpdatePanel1, this.GetType(), "click", "window.open('" + filename + "');", true);
        }

        protected void btn_monthrpt2_1_Click(object sender, EventArgs e)
        {
            string pdflink1 = System.Configuration.ConfigurationManager.AppSettings["pdflink"].ToString();

            string tmp_url = "C_overtime_monthrpt2.aspx?pdf=0&ctype=" + rbl_print.SelectedValue + "&MZ_ID=" + txt_MZ_ID.Text.Trim() + "&PM_FION=" + TPM_FION +
                     "&Year=" + txt_Year.Text +
                     "&AD=" + ddl_Search_AD.SelectedValue + "&UNIT=" + ddl_Search_Unit.SelectedValue;
