<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="C_overtime_allrpt1.aspx.cs" Inherits="TPPDDB._3_forleave.C_overtime_allrpt1" %>
<% string textfont = "";
    if (Request["pdf"] != "1")
    {
        string filename = HttpContext.Current.Server.UrlEncode("業務加班費補發總清冊.xls");
...
<body>
	...
	<tr height=50 style="font-size:20px;" > 
		<td align=center colspan="6"><B><%=adtitle%><%=unitname%><%=year1.Substring(0,3)%>年<%=year1.Substring(3,2)%>月至<%=year2.Substring(3,2)%>月業務加班費補發總清冊</B></td>
	</tr>
	<tr>
		<td colspan="8">  
