<%@ Page  Language="C#" MasterPageFile="~/TPPD.Master" AutoEventWireup="true"  CodeBehind="C_ForleaveOverTime_stat.aspx.cs" Inherits="TPPDDB._3_forleave.C_ForleaveOverTime_stat" %>
                ...
                <asp:Table runat="server" Width="100%">
                    ...
                    <asp:TableRow>
                     ...
                     <asp:TableRow>
                        ...
                        <asp:TableCell style="text-align: left;">
                            <asp:RadioButtonList ID="rbl_halftype" runat="server" RepeatDirection="Horizontal">
                                        <asp:ListItem Text ="上半年" Value="0" Selected="True"></asp:ListItem>  
                                        <asp:ListItem Text ="下半年" Value="1" ></asp:ListItem>  
                            </asp:RadioButtonList>
                        </asp:TableCell>
                    </asp:TableRow>
                    <asp:TableRow>
                ...
                <table width="100%">
                    <tr>
                        <td style="text-align: center;">
                           <%-- <asp:Button runat="server" ID="btn_allrpt1" Text="業務加班補發總清冊" CssClass="style9" OnClick="btn_allrpt1_Click"/>
                            <asp:Button runat="server" ID="btn_allrpt1_1" Text="業務加班補發總清冊(Excel)" CssClass="style9" OnClick="btn_allrpt1_1_Click"/>--%>
                            <asp:Button runat="server" ID="btn_statrpt1" Text="超勤報表"  OnClick="btn_statrpt1_Click" />
                            <asp:Button runat="server" ID="btn_statrpt2" Text="超勤及業務加班報表"  OnClick="btn_statrpt2_Click" />
                        </td>
                    </tr>
                </table>
             </asp:Panel>
