<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="C_overtime_monthrpt2.aspx.cs" Inherits="TPPDDB._3_forleave.C_overtime_monthrpt2" %>
<% string textfont = "";
    if (Request["pdf"] != "1")
    {
        string filename = HttpContext.Current.Server.UrlEncode("超勤加班費補發清冊.xls");
...
<body>
    ...
    <%
        ...
        while (dr.Read())
        {
            ...
            dr1.Close();
            ddlAD_SQL = "SELECT RTRIM(MZ_KCHI) MZ_KCHI FROM A_KTYPE WHERE MZ_KTYPE='25' and MZ_KCODE = '" + unit + "'";
            cmd1.CommandText = ddlAD_SQL;
            dr1 = cmd1.ExecuteReader();
            if (dr1.Read())
            {
            ...
            hour1 = dr["MZ_REAL_HOUR"].ToString() ;
	...
	<tr height=50 style="font-size:20px;" > 
		<td align=center colspan="6"><B><%=adtitle%><%=unitname%><%=year1.Substring(0,3)%>年<%=year1.Substring(3,2)%>月份超勤加班費補發清冊</B></td>
	</tr>
	<tr>
		<td colspan="8">  
