<%@ Page Title="" Language="C#" MasterPageFile="~/TPPD.Master" AutoEventWireup="true" CodeBehind="C_OvertimeInsideAsk_rpt_New.aspx.cs" Inherits="TPPDDB._3_forleave.C_OvertimeInsideAsk_rpt_New" %>
                ...
                <table width="100%">
                    <tr>
                        ...
                        <td style="text-align: left">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TextBox_MZ_ID"
                    ...
                    <tr>
                        ...
                        <td style="text-align: left">
                            <asp:TextBox ID="TextBox_MZ_DATE" runat="server" MaxLength="9" Width="65px"></asp:TextBox>
                            （範例:0980101）
                        </td>
                    </tr>
                </table>
