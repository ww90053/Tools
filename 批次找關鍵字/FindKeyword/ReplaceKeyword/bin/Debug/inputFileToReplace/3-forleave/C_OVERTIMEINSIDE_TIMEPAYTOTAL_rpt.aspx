<%@ Page Title="" Language="C#" MasterPageFile="~/TPPD.Master" AutoEventWireup="true" CodeBehind="C_OVERTIMEINSIDE_TIMEPAYTOTAL_rpt.aspx.cs" Inherits="TPPDDB._3_forleave.C_OVERTIMEINSIDE_TIMEPAYTOTAL_rpt" %>
                ...
                <asp:Panel ID="Panel1" runat="server" GroupingText="查詢條件" Width="423px">
                    <table width="100%">
                        ...
                        <tr>
                            ...
                            <td style="text-align: left">
                                <asp:TextBox ID="TextBox_DATE_S" runat="server" Style="text-align: left" MaxLength="7"
                                    Width="65px"></asp:TextBox>
                                ~
                                <asp:TextBox ID="TextBox_DATE_E" runat="server" Style="text-align: left" MaxLength="7"
                                    Width="65px"></asp:TextBox>
