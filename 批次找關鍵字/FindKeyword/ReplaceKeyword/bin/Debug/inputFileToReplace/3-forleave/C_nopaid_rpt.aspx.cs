...
{
    public partial class C_nopaid_rpt : System.Web.UI.Page
    {
        int TPM_FION = 0;
        ...
        {
            string strSQL = "SELECT MZ_ID,MZ_POLNO,MZ_OCCC,'1' AS UNIT,MZ_UNIT,PAY_AD,MZ_NAME,MZ_OCCC AS OCCC,dbo.to_number(CASE WHEN MZ_TBDV IS NULL THEN '999' WHEN MZ_TBDV='Z99' THEN '999' ELSE MZ_TBDV END) AS TBDV FROM A_DLBASE WHERE 1=1 ";
            string SQLPART = "";
            ...
            strSQL += " AND MZ_ID NOT IN (SELECT IDCARD FROM B_SOLE WHERE 1=1 " + SQLPART + " AND NUM = '5')";
            ...
            string tmp_url = "C_rpt.aspx?fn=nopaid&TPM_FION=" + TPM_FION;
