<%@ Page Title="" Language="C#" MasterPageFile="~/TPPD.Master" AutoEventWireup="true"
    CodeBehind="C_OvertimeInsideDetail_rpt.aspx.cs" Inherits="TPPDDB._3_forleave.C_OvertimeInsideDetail_rpt" %>
                ...
                <tr>                    
                    <td style="text-align: left">
                        <span style="color:red;">
                            各機關加班費支給要點第一點規定，加班費之支給，以各機關員工在規定上班時間以外，經主管覈實指派延長工作者為限。準此，於上班時間外，出席餐會用餐或參加非屬推展勤業務之活動，皆不符合加班規定。
                        </span>
                    </td>
                </tr>
            </table>
