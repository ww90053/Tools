<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/TPPD.Master"   CodeBehind="A3_SalaryCheck.aspx.cs" Inherits="TPPDDB._3_forleave.A3_SalaryCheck" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                ...
                <table id="tb1" width="100%">
                    ...
                    <tr>
                        <td colspan="2" class="tdstyle">
                            <asp:Button ID="btn_Out" runat="server" Text="比對匯出" OnClick="btn_Out_Click"/>
                            &nbsp;
                        </td>
                    </tr>
                    <tr>
        ...
        <Triggers>            
            <asp:PostBackTrigger ControlID="btn_Out" />
        </Triggers>
    </asp:UpdatePanel>
            ...
            <div class="modal">
                <div class="center">
                   <img alt="" src="../images/ajax-loader.gif" style="width: 328px; height: 19px" /><br />
                        <span class="style3">資料比對中，請稍待…</span>
                </div>
            </div>
        </ProgressTemplate>
    </asp:UpdateProgress>
