...
{
    public partial class C_ForleaveOverTime_rpt : System.Web.UI.Page
    {
        string TPM_FION = "";
        /// <summary>
        /// 初始化各頁面功能
        ...
        protected void btn_monthrpt1_Click(object sender, EventArgs e)
        {
            ...
            string tmp_url = "C_overtime_monthrpt1.aspx?pdf=1&ctype=" + rbl_print.SelectedValue + "&MZ_ID=" + txt_MZ_ID.Text.Trim() + "&PM_FION=" + TPM_FION +
                     "&Year=" + txt_Year.Text +
        ...
        protected void btn_monthrpt1_1_Click(object sender, EventArgs e)
        {
            ...
            string tmp_url = "C_overtime_monthrpt1.aspx?pdf=0&ctype=" + rbl_print.SelectedValue + "&MZ_ID=" + txt_MZ_ID.Text.Trim() + "&PM_FION=" + TPM_FION +
                     "&Year=" + txt_Year.Text +
                     "&AD=" + ddl_Search_AD.SelectedValue + "&UNIT=" + ddl_Search_Unit.SelectedValue;
        //    string filename = "/userfiles/" + DateTime.Now.ToString("yyyyMMddHHmmssff") + ".pdf";
            string url = "http://" + Request.ServerVariables["Server_Name"] + ":" + Request.ServerVariables["Server_port"] + "/3-forleave/" + tmp_url;
