<%@ Page Title="" Language="C#" MasterPageFile="~/TPPD.Master" AutoEventWireup="true"
    CodeBehind="C_ForLeaveOvertime_ONDUTYHOUR_KEYIN_RPT.aspx.cs" Inherits="TPPDDB._3_forleave.C_ForLeaveOvertime_ONDUTYHOUR_KEYIN_RPT" %>
    ...
    <script type="text/javascript">
        ...
        function beginRequestHandler(sender, args) {
            if (args.get_postBackElement().id === 'ctl00_ContentPlaceHolder1_Button_MAKE_RPT') {
                document.getElementById("ctl00_ContentPlaceHolder1_Button_CANCEL").disabled = true;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                <asp:Panel ID="Panel1" runat="server" GroupingText="查詢條件" Height="165px" Width="361px">
                    <table class="style1">
                        <tr>
                            <td class="style2">
                                機關：
                        ...
                        <tr>
                            ...
                            <td style="text-align: left">
                                ...
                                <asp:SqlDataSource ID="SqlDataSource_UNIT" runat="server" ConnectionString="<%$ ConnectionStrings:MSDBConnectionString_toTest %>"
                                    ProviderName="<%$ ConnectionStrings:MSDBConnectionString_toTest.ProviderName %>" 
                                    SelectCommand="SELECT RTRIM(MZ_KCODE)+RTRIM(MZ_KCHI),RTRIM(MZ_KCODE) FROM A_KTYPE WHERE MZ_KTYPE='25' AND MZ_KCODE IN (SELECT MZ_UNIT FROM A_UNIT_AD WHERE MZ_AD=@MZ_AD)" 
                                    DataSourceMode="DataReader">
                                    <SelectParameters>
                        ...
                        <tr>
                            ...
                            <td style="text-align: left">
                                ...
                                <%-- DataSourceID="SqlDataSource_YEAR"
                                ...
                                <%--<asp:SqlDataSource ID="SqlDataSource_YEAR" runat="server" ConnectionString="<%$ ConnectionStrings:MSDBConnectionString_toTest %>"
                                    ProviderName="<%$ ConnectionStrings:MSDBConnectionString_toTest.ProviderName %>" 
                                    SelectCommand="SELECT DISTINCT MZ_YEAR FROM C_ONDUTY_HOUR order by  MZ_YEAR desc" 
                                    DataSourceMode="DataReader">
                                </asp:SqlDataSource>--%>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td class="style2" colspan="2">
                                <asp:Button ID="Button_MAKE_RPT" runat="server" Text="產生報表" OnClick="Button_MAKE_RPT_Click" />
