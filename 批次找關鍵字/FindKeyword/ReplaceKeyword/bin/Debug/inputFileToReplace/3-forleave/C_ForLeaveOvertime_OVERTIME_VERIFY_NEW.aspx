<%@ Page Language="C#" MasterPageFile="~/TPPD.Master" AutoEventWireup="true" CodeBehind="C_ForLeaveOvertime_OVERTIME_VERIFY_NEW.aspx.cs"
    Inherits="TPPDDB._3_forleave.C_ForLeaveOvertime_OVERTIME_VERIFY_NEW" %>
                        ...
                        <div style="width:800px; height:400px;overflow:auto;">
                            <asp:GridView ID="GridView1" runat="server" Width="1500px" HeaderStyle-BackColor="Aqua"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="MZ_BALANCE_HOUR" SortExpression="MZ_BALANCE_HOUR">
                                    <ItemTemplate>
                                            <asp:TextBox ID="TextBox_MZ_BALANCE_HOUR" runat="server" AutoPostBack="True" OnTextChanged="TextBox_MZ_REMARK_TextChanged"
                                                Width="30px" Text='<%# Eval("MZ_BALANCE_HOUR") %>' Enabled='<%# Eval("MZ_VERIFY").ToString() =="Y"?false:true %>'></asp:TextBox>
                                        </ItemTemplate>
                                    ...
                                    <ItemTemplate>
                                            <asp:TextBox ID="TextBox_BOSS" runat="server" AutoPostBack="True" OnTextChanged="TextBox_MZ_REMARK_TextChanged"
                                                Width="40px" Text='<%# Eval("BOSS") %>' Enabled='<%# Eval("MZ_VERIFY").ToString() =="Y"?false:true %>'></asp:TextBox>
                                        </ItemTemplate>
