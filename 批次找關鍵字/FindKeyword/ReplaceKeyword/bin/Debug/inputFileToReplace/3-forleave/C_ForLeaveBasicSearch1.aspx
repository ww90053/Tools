<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="C_ForLeaveBasicSearch1.aspx.cs"
    Inherits="TPPDDB._3_forleave.C_ForLeaveBasicSearch1" %>
            ...
            <asp:Panel ID="Panel2" runat="server" Width="100%">
                <table class="style52" border="1" width="100%">
                    ...
                    <tr>
                        ...
                        <td class="style59">
                            <asp:TextBox ID="TextBox_ID" runat="server" Font-Bold="True" ForeColor="Maroon"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="style61">
                ...
                <asp:Panel ID="Panel1" runat="server" Width="100%" Visible="False">
                    <table class="style52" border="1" width="100%">
                        <tr>
                            ...
                            <td class="style57">
                                <asp:TextBox ID="TextBox_MZ_IDATE1" runat="server" MaxLength="7" Width="65px" Font-Bold="True"
                                    ForeColor="Maroon"></asp:TextBox>
                                -<asp:TextBox ID="TextBox_MZ_IDATE2" runat="server" Font-Bold="True" ForeColor="Maroon"
                                    MaxLength="7" Width="65px"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TextBox_MZ_IDATE1"
                                    ErrorMessage="不可空白" Display="Dynamic"></asp:RequiredFieldValidator>
                                (範例：0990101)
                            </td>
                        </tr>
                        <tr>
