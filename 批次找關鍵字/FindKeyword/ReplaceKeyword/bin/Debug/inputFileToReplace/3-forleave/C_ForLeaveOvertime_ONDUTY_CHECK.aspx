<%@ Page Title="" Language="C#" MasterPageFile="~/TPPD.Master" AutoEventWireup="true" CodeBehind="C_ForLeaveOvertime_ONDUTY_CHECK.aspx.cs" Inherits="TPPDDB._3_forleave.C_ForLeaveOvertime_ONDUTY_CHECK" %>
                    ...
                    <cc1:TBGridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="核可否" SortExpression="IS_CHK">                             
                                <ItemTemplate>
                                    <asp:CheckBox ID="CheckBox_CHK1" runat="server" Checked='<%# Eval("IS_CHK").ToString()=="Y"?true:false %>' />
                                <asp:Label ID="lb_SN" runat="server" Text='<%# Eval("SN") %>' Visible="false"></asp:Label>
                                <asp:Label ID="lb_CHK" runat="server" Text='<%# Eval("IS_CHK").ToString() %>' Visible="false"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>     
                            <asp:BoundField DataField="IS_CHK_UNIT" HeaderText="單位審核" />
                    ...
                    <th>
                     ...
                     <tr>
                      ...
                      <th>
                        ...
                        -
                           <asp:TextBox ID="txt_DATE2" runat="server" Width="60px" MaxLength="7" ></asp:TextBox>(0990131)
                        </td>
