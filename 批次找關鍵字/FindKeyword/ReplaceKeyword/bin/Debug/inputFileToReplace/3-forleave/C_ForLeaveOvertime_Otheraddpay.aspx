<%@ Page Language="C#" MasterPageFile="~/TPPD.Master" AutoEventWireup="true" CodeBehind="C_ForLeaveOvertime_Otheraddpay.aspx.cs"
    Inherits="TPPDDB._3_forleave.C_ForLeaveOvertime_Otheraddpay" %>
                        ...
                        <div style="width:800px; height:400px;overflow:auto;">
                            <asp:GridView ID="GridView1" runat="server" Width="1000px" HeaderStyle-BackColor="Aqua"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="MZ_REAL_HOUR" HeaderText="MZ_REAL_HOUR" SortExpression="MZ_BUDGET_HOUR">
                                        <ItemStyle Width="30px" />
                                    </asp:BoundField>
                                     <asp:TemplateField HeaderText="MZ_REMARK" SortExpression="MZ_REMARK">
                                        <ItemTemplate>
                                            <asp:TextBox ID="TXT_MZ_REMARK" runat="server"  
                                                Width="76px" Text='<%# Eval("MZ_REMARK_UP") %>'  OnTextChanged="TextBox_MZ_REMARK_TextChanged"></asp:TextBox>
                                        </ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="MZ_HOUR_PAY" ItemStyle-Width="60px" SortExpression="MZ_HOUR_PAY">
                                        <ItemTemplate>
                                            <asp:TextBox ID="HOUR_PAY" runat="server" AutoPostBack="True" 
                                                Width="30px" Text='<%# Eval("MZ_HOUR_PAY") %>' Enabled='false'></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                   ...
                                   <asp:TemplateField HeaderText="MZ_OVERTIME_PAY1" SortExpression="MZ_OVERTIME_PAY1">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txt_MZ_OVERTIME_PAY1" runat="server" Width="50px" Text='<%# Eval("MZ_OVERTIME_PAY1") %>' OnTextChanged="TextBox_MZ_REMARK_TextChanged" ></asp:TextBox>
                                        </ItemTemplate>
