...
{
    public partial class C_ForLeaveBasicSearch : System.Web.UI.Page
    {
        ...
        protected void Button_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                ScriptManager.RegisterClientScriptBlock(UpdatePanel1, this.GetType(), "click", "window.opener.location.href='C_ForLeaveBasic.aspx?SEARCHMODE=DLTB01&MZ_EXAD=" + EXAD + "&MZ_EXUNIT=" + EXUNIT + "&MZ_IDATE1=" + IDATE1 + "&TPM_FION=" + Request.QueryString["TPM_FION"] + "';window.close();", true);
            }
        }
