<%@ Page Title="" Language="C#" MasterPageFile="~/TPPD.Master" AutoEventWireup="true"
    CodeBehind="Personal_ABORIGINE2_rpt.aspx.cs" Inherits="TPPDDB._1_personnel.Personal_ABORIGINE2_rpt" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <script type="text/javascript">
        ...
        function beginRequestHandler(sender, args) {
            if (args.get_postBackElement().id === 'ctl00_ContentPlaceHolder1_btABORIGINE1') {
                    ...
                    <table width="100%">
                        <tr>
                            <td class="style2" colspan="2" style="text-align: center">
                                <asp:Button ID="btABORIGINE1" runat="server" Text="預覽列印" OnClick="btABORIGINE1_Click" />
