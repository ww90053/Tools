...
{
    public partial class Personal_Card_All_rpt : System.Web.UI.Page
    {
        ...
        protected void Button_MAKE_ALL_Click(object sender, EventArgs e)
        {
                ...
                for (int i = 0; i < out_count; i++)
                {
                    ...
                    else
                    {
                        ...
                        for (int j = 6 * i + 1; j <= tempDT.Rows.Count; j++)
                        {
                            ...
                            dr["MZ_NO1_" + columns.ToString()] = tempDT.Rows[j - 1]["MZ_NO1"].ToString();
                            string DATE = tempDT.Rows[j - 1]["MZ_DATE"].ToString();
                            dr["MZ_DATE" + columns.ToString()] = DATE.Substring(0, 3) + "年" + DATE.Substring(3, 2).PadLeft(2, '0') + "月" + DATE.Substring(5, 2).PadLeft(2, '0') + "日";
                        }
                        k++;
                        dr["PAGE_COUNT"] = k.ToString("000");
                        Card_All.Rows.Add(dr);
            ...
            string tmp_url = "A_rpt.aspx?fn=Card_All_Criminal_Horizontal";
        ...
        protected void Button_MAKE_ALL1_Click(object sender, EventArgs e)
        {
            ...
            string tmp_url = "A_rpt.aspx?fn=Card_All_Vertical";
            ScriptManager.RegisterClientScriptBlock(Panel1, this.GetType(), "click", "go_print('" + tmp_url + "');", true);
        }
