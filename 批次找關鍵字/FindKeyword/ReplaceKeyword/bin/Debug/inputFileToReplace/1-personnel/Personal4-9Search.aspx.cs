...
{
    public partial class Personal4_9Search : System.Web.UI.Page
    {
        ...
        {
            ScriptManager.RegisterClientScriptBlock(UpdatePanel1, this.GetType(), "click", "window.opener.location.href='Personal4-9.aspx?MZ_UNIT=" + TextBox_MZ_UNIT.Text .Trim () + "&MZ_AD=" + DropDownList_AD.SelectedValue.Trim() + "&TPM_FION=" + Request.QueryString["TPM_FION"] + "';window.close();", true);
        }
