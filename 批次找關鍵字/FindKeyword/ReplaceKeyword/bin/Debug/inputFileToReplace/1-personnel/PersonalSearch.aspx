<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PersonalSearch.aspx.cs"
    Inherits="TPPDDB._1_personnel.PersonalSearch" %>
                ...
                <asp:Panel ID="Panel1" runat="server">
                    <table border="1" class="style2" width="400px">
                        <tr>
                            ...
                            <td class="style4">
                                <asp:TextBox ID="TextBox_NAME" runat="server" MaxLength="6" Width="100px" CssClass="SEARCH_DROPDOWNLIST"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="style7">
