<%@ Page Title="" Language="C#" MasterPageFile="~/TPPD.Master" AutoEventWireup="true"
    CodeBehind="Personal_Criminal_police2_rpt.aspx.cs" Inherits="TPPDDB._1_personnel.Personal_Criminal_police2_rpt" %>
            ...
            <div>
                <asp:Panel ID="Panel1" runat="server" GroupingText="查詢條件" Width="514px">
                    <table width="100%">
                        ...
                        <td style="text-align: left">
                            <asp:TextBox ID="txt_Year" runat="server" Width="83px"></asp:TextBox>~<asp:TextBox ID="txt_Year2" runat="server" Width="83px"></asp:TextBox>&nbsp; 
                            (範例:1020701)
                            </td>
                        </tr>
