...
{
    public partial class Personal_ABORIGINE3_rpt : System.Web.UI.Page
    {
        int TPM_FION=0;
        ...
        protected void btABORIGINE2_Click(object sender, EventArgs e)
        {
            ...
            {
                //警務員
                string M_1455 = o_DBFactory.ABC_toTest.vExecSQL("SELECT COUNT(*) FROM A_DLBASE WHERE MZ_STATUS2='Y' AND (MZ_TBDV='008' OR MZ_TBDV='007') AND MZ_SM='1' AND MZ_ABORIGINE='Y' AND MZ_EXAD='" + tempEXAD_dt.Rows[i][0].ToString() + "'");
                string F_1455 = o_DBFactory.ABC_toTest.vExecSQL("SELECT COUNT(*) FROM A_DLBASE WHERE MZ_STATUS2='Y' AND (MZ_TBDV='008' OR MZ_TBDV='007') AND MZ_SM='2' AND MZ_ABORIGINE='Y' AND MZ_EXAD='" + tempEXAD_dt.Rows[i][0].ToString() + "'");
                ...
                //巡佐
                string M_1460 = o_DBFactory.ABC_toTest.vExecSQL("SELECT COUNT(*) FROM A_DLBASE WHERE MZ_STATUS2='Y' AND MZ_TBDV='010' AND MZ_SM='1' AND MZ_ABORIGINE='Y' AND MZ_EXAD='" + tempEXAD_dt.Rows[i][0].ToString() + "'");
                string F_1460 = o_DBFactory.ABC_toTest.vExecSQL("SELECT COUNT(*) FROM A_DLBASE WHERE MZ_STATUS2='Y' AND MZ_TBDV='010' AND MZ_SM='2' AND MZ_ABORIGINE='Y' AND MZ_EXAD='" + tempEXAD_dt.Rows[i][0].ToString() + "'");
                ...
                //巡官
                string M_1450 = o_DBFactory.ABC_toTest.vExecSQL("SELECT COUNT(*) FROM A_DLBASE WHERE MZ_STATUS2='Y' AND MZ_TBDV='009' AND MZ_SM='1' AND MZ_ABORIGINE='Y' AND MZ_EXAD='" + tempEXAD_dt.Rows[i][0].ToString() + "'");
                string F_1450 = o_DBFactory.ABC_toTest.vExecSQL("SELECT COUNT(*) FROM A_DLBASE WHERE MZ_STATUS2='Y' AND MZ_TBDV='009' AND MZ_SM='2' AND MZ_ABORIGINE='Y' AND MZ_EXAD='" + tempEXAD_dt.Rows[i][0].ToString() + "'");
                ...
                //警員
                string M_1453 = o_DBFactory.ABC_toTest.vExecSQL("SELECT COUNT(*) FROM A_DLBASE WHERE MZ_STATUS2='Y' AND MZ_TBDV='011' AND MZ_SM='1' AND MZ_ABORIGINE='Y' AND MZ_EXAD='" + tempEXAD_dt.Rows[i][0].ToString() + "'");
                string F_1453 = o_DBFactory.ABC_toTest.vExecSQL("SELECT COUNT(*) FROM A_DLBASE WHERE MZ_STATUS2='Y' AND MZ_TBDV='011' AND MZ_SM='2' AND MZ_ABORIGINE='Y' AND MZ_EXAD='" + tempEXAD_dt.Rows[i][0].ToString() + "'");
