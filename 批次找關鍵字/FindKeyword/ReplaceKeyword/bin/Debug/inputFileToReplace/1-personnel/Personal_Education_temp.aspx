<%@ Page Title="" Language="C#" MasterPageFile="~/TPPD.Master" AutoEventWireup="true"
    CodeBehind="Personal_Education_temp.aspx.cs" Inherits="TPPDDB._1_personnel.Personal_Education_temp" %>
        ...
        <ContentTemplate>
            ...
            <table border="1" style="width: 100%;">
                ...
                <tr>
                    ...
                    <td class="style2">
                        <asp:TextBox ID="TextBox_MZ_SCHOOL" runat="server" Width="75px"></asp:TextBox>
                        <asp:Label ID="Label_MZ_SCHOOL" runat="server" CssClass="KEY_IN_LABLE"></asp:Label>
                    </td>
                    <td class="style5">
                        科&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 系
                    </td>
                    <td class="style1">
                        <asp:TextBox ID="TextBox_MZ_DEPARTMENT" runat="server" Width="50px"></asp:TextBox>
                        <asp:Label ID="Label_MZ_DEPARTMENT" runat="server" CssClass="KEY_IN_LABLE"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td class="style6">
                    ...
                    <td class="style1">
                        <asp:TextBox ID="TextBox_MZ_EDUKIND" runat="server" Width="30px"></asp:TextBox>
                        <asp:Label ID="Label_MZ_EDUKIND" runat="server" CssClass="KEY_IN_LABLE"></asp:Label>
                    </td>
                </tr>
            </table>
