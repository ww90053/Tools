<%@ Page Title="" Language="C#" MasterPageFile="~/TPPD.Master" AutoEventWireup="true"
    CodeBehind="Personal_Code.aspx.cs" Inherits="TPPDDB._1_personnel.Personal_Code" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <asp:Panel ID="Panel_ID" runat="server">
                <table border="1" class="style1">
                    <tr>
                        ...
                        <td class="style4">
                            <asp:TextBox ID="TextBox_ID" runat="server" MaxLength="8" Width="100px"></asp:TextBox>
                        </td>
                        <td class="style40">
                            資料表名稱
                        </td>
                        <td class="style4">
                            <asp:TextBox ID="TextBox_TABLE_NAME" runat="server" MaxLength="8" Width="200px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="style41">
                        ...
                        <td style="text-align: left">
                            <asp:TextBox ID="TextBox_CODE" runat="server" Width="100px"></asp:TextBox>
                        </td>
                        <td class="style40">
                            備&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 註
                        </td>
                        <td style="text-align: left">
                            <asp:TextBox ID="TextBox_MEMO" runat="server" Width="400px"></asp:TextBox>
                        </td>
                    </tr>
                </table>
            </asp:Panel>
                    ...
                    <tr>
                        <td class="style5">
                            ...
                            <asp:Button ID="btOK" runat="server" meta:resourcekey="btOKResource1" OnClick="btOK_Click"
                                Text="確定" Enabled="False" CssClass="KEY_IN_BUTTON_BLUE" />
            ...
            <asp:Panel ID="Panel1" runat="server" Height="300px">
                <cc1:TBGridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                    ...
                    <Columns>
                        <asp:BoundField DataField="ID" HeaderText="機關代碼" SortExpression="ID">
                            <ItemStyle Width="100px" />
                        </asp:BoundField>
                        <asp:BoundField DataField="CODE" HeaderText="機關名稱" SortExpression="CODE" />
                        <asp:BoundField DataField="TABLE_NAME" HeaderText="資料表名稱" SortExpression="TABLE_NAME" />
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:MSDBConnectionString_toTest %>"
                    ProviderName="<%$ ConnectionStrings:MSDBConnectionString_toTest.ProviderName %>" SelectCommand="SELECT * FROM &quot;A_CODE&quot;">
                </asp:SqlDataSource>
            </asp:Panel>
        </ContentTemplate>
    </asp:UpdatePanel>
