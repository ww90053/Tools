<%@ Page Title="" Language="C#" MasterPageFile="~/TPPD.Master" AutoEventWireup="true"
    CodeBehind="Personal_quit_rpt.aspx.cs" Inherits="TPPDDB._1_personnel.Personal_quit_rpt" %>
                            ...
                            <tr>
                                ...
                                <td style="text-align: left">
                                    <asp:RadioButtonList ID="RadioButtonList1" runat="server" RepeatColumns="2">
                                        <asp:ListItem Value="1" Selected="True">警局用</asp:ListItem>
                                        <asp:ListItem Value="2">分局用</asp:ListItem>
                                    </asp:RadioButtonList>
                                </td>
                            </tr>
                        </tbody>
