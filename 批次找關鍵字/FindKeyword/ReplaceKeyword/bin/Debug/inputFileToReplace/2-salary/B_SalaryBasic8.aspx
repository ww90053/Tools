<%@ Page Title="" Language="C#" MasterPageFile="~/TPPD.Master" AutoEventWireup="true" CodeBehind="B_SalaryBasic8.aspx.cs" Inherits="TPPDDB._2_salary.B_SalaryBasic8" %>
...
<table border="1" class="style1">
        ...
        <tr>
            <td colspan="4">
                <asp:GridView ID="GridView_ADVENTIVE" runat="server" AutoGenerateColumns="False" 
                    CellPadding="4" DataKeyNames="ID" DataSourceID="SqlDataSource_ADVENTIVE" 
                    GridLines="None" onrowcommand="GridView_ADVENTIVE_RowCommand" 
                ...
                <asp:SqlDataSource ID="SqlDataSource_ADVENTIVE" runat="server" 
                    ...
                    SelectCommand="SELECT ID, NAME, PAY, CREATEDATE FROM B_ADVENTIVE ORDER BY ID ASC">
                </asp:SqlDataSource>
            </td>
        </tr>
        <tr>
