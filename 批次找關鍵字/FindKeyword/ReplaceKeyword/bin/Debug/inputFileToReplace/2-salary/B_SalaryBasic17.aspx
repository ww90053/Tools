<%@ Page Title="" Language="C#" MasterPageFile="~/TPPD.Master" AutoEventWireup="true" CodeBehind="B_SalaryBasic17.aspx.cs" Inherits="TPPDDB._2_salary.B_SalaryBasic17" %>
...
<table border="1" class="style1">
        ...
        <tr>
            <td colspan="4">
                <asp:GridView ID="GridView_SALARY_VALET" runat="server" AutoGenerateColumns="False" 
                    CellPadding="4" DataKeyNames="ID" DataSourceID="SqlDataSource_SALARY_VALET" 
                    GridLines="None" onrowcommand="GridView_SALARY_VALET_RowCommand" 
                ...
                <asp:SqlDataSource ID="SqlDataSource_SALARY_VALET" runat="server" 
                    ...
                    SelectCommand="SELECT ID, NAME, PAY, CREATEDATE FROM B_SALARY_VALET ORDER BY ID ASC">
                </asp:SqlDataSource>
            </td>
        </tr>
        <tr>
