<%@ Page Title="" Language="C#" MasterPageFile="~/TPPD.Master" AutoEventWireup="true" CodeBehind="B_effectlist_rpt.aspx.cs" Inherits="TPPDDB._2_salary.B_effectlist_rpt" %>
...
<div class="title_s1">考績獎金印領清冊-科室總表</div>
<div></div>
<div>
        ...
        <table class="style1">
            ...
            <tr>
                ...
                <td style="text-align: left">
                    ...
                    <cc1:FilteredTextBoxExtender ID="TextBox_YEAR_FilteredTextBoxExtender5" 
