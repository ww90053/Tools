<%@ Page Title="" Language="C#" MasterPageFile="~/TPPD.Master" AutoEventWireup="true"
    CodeBehind="B_SalaryBasic13.aspx.cs" Inherits="TPPDDB._2_salary.B_SalaryBasic13" %>
        ...
        <ContentTemplate>
            <table border="1" class="style1">
                ...
                <tr>
                    ...
                    <td class="style3">
                        <asp:TextBox ID="TextBox_PAY2" runat="server" AutoPostBack="True" OnTextChanged="voidChanged"></asp:TextBox>
                        <cc1:FilteredTextBoxExtender ID="TextBox_PAY2_FilteredTextBoxExtender" runat="server"
                            Enabled="True" FilterType="Custom, Numbers" TargetControlID="TextBox_PAY2" ValidChars="-$,.">
                        </cc1:FilteredTextBoxExtender>
                    </td>
                </tr>
                <tr>
                    <td colspan="4">
                        <div style="height: 380px; overflow: scroll;">
                            <asp:GridView ID="GridView_HEALTH_INSURANCE" runat="server" AutoGenerateColumns="False"
                                CellPadding="4" DataKeyNames="ID" DataSourceID="SqlDataSource_HEALTH_INSURANCE"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="INSURANCE" HeaderText="健保費金額" SortExpression="INSURANCE"
                        ...
                        <asp:SqlDataSource ID="SqlDataSource_HEALTH_INSURANCE" runat="server" ConnectionString="<%$ ConnectionStrings:MSDBConnectionString_toTest %>"
