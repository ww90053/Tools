<%@ Page Title="" Language="C#" MasterPageFile="~/TPPD.Master" AutoEventWireup="true" CodeBehind="已經廢止_B_InsuranceStatistics_rpt.aspx.cs" Inherits="TPPDDB._2_salary.已經廢止_B_InsuranceStatistics_rpt" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table style="width:417;">
        ...
        <tr>
            <td colspan="2">
                <asp:Button ID="Button_Send" runat="server" Text="送出" 
