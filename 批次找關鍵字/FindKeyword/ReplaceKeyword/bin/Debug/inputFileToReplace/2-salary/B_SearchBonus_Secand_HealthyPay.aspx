<%@ Page Title="" Language="C#" MasterPageFile="~/TPPD.Master" AutoEventWireup="true" CodeBehind="B_SearchBonus_Secand_HealthyPay.aspx.cs" Inherits="TPPDDB._2_salary.B_SearchBonus_Secand_HealthyPay" %>
        ...
        <table class="style1">
           ...
           <tr>
                <td class="style2" style="text-align: right">
                    批號：</td>
                <td style="text-align: left">
                    <asp:TextBox ID="TextBox_CaseID" runat="server" Height="19px" MaxLength="5" 
                        Width="85px"></asp:TextBox>
                    </td>
            </tr>
