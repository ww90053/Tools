<%@ Page Title="" Language="C#" MasterPageFile="~/TPPD.Master" AutoEventWireup="true"
    CodeBehind="B_SalaryBasic7.aspx.cs" Inherits="TPPDDB._2_salary.B_SalaryBasic7" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <table border="1" class="style1">
                ...
                <tr>
                    ...
                    <td class="style3">
                        ...
                        <cc1:FilteredTextBoxExtender ID="TextBox_PAY_FilteredTextBoxExtender" runat="server"
                            Enabled="True" TargetControlID="TextBox_PAY" FilterType="Custom, Numbers" ValidChars="-$,.">
                ...
                <tr>
                    <td colspan="4">
                        <asp:GridView ID="GridView_BONUS" runat="server" AutoGenerateColumns="False" 
                            CellPadding="4" DataKeyNames="ID"
                            DataSourceID="SqlDataSource_BONUS" GridLines="None" OnRowCommand="GridView_BONUS_RowCommand"
                        ...
                        <asp:SqlDataSource ID="SqlDataSource_BONUS" runat="server" ConnectionString="<%$ ConnectionStrings:MSDBConnectionString_toTest %>"
                            ProviderName="<%$ ConnectionStrings:MSDBConnectionString_toTest.ProviderName %>" SelectCommand="SELECT ID, NAME, PAY, CREATEDATE FROM B_BONUS ORDER BY ID ASC">
                        </asp:SqlDataSource>
                    </td>
                </tr>
                <tr>
