<%@ Page Title="" Language="C#" MasterPageFile="~/TPPD.Master" AutoEventWireup="true"
    CodeBehind="B_SalaryBasic5.aspx.cs" Inherits="TPPDDB._2_salary.B_SalaryBasic5" %>
        ...
        <ContentTemplate>
            <table border="1" class="style1">
                ...
                <tr>
                    ...
                    <td class="style3">
                        <asp:TextBox ID="TextBox_NAME" runat="server" MaxLength="20"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td class="style2">
                ...
                <tr>
                    <td colspan="4">
                        <asp:GridView ID="GridView_TECHNICS" runat="server" AutoGenerateColumns="False" 
                            CellPadding="4" DataKeyNames="ID"
                            DataSourceID="SqlDataSource_TECHNICS" GridLines="None" OnRowCommand="GridView_TECHNICS_RowCommand"
                        ...
                        <asp:SqlDataSource ID="SqlDataSource_TECHNICS" runat="server" ConnectionString="<%$ ConnectionStrings:MSDBConnectionString_toTest %>"
                            ProviderName="<%$ ConnectionStrings:MSDBConnectionString_toTest.ProviderName %>" SelectCommand="SELECT ID, NAME, PAY, CREATEDATE FROM B_TECHNICS ORDER BY ID ASC">
                        </asp:SqlDataSource>
                    </td>
                </tr>
                <tr>
