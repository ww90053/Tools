<%@ Page Title="" Language="C#" MasterPageFile="~/TPPD.Master" AutoEventWireup="true"
    CodeBehind="B_SalaryToBank.aspx.cs" Inherits="TPPDDB._2_salary.B_SalaryToBank" %>
                            ...
                            <table width="100%">
                                <tr>
                                    <td style="text-align: center;">
                                        <asp:Button ID="btToTXT" runat="server" OnClick="btToTXT_Click" Text="儲存" ForeColor="Red" />
                                    </td>
                                    <td style="text-align: center;">
                                ...
                                <tr>
                                <td style="text-align: center;">
                                        <asp:Button ID="btToTXT_encryption" runat="server"  Text="儲存成加密檔"  
