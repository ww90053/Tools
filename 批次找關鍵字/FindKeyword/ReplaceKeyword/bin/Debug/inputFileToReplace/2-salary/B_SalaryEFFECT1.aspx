<%@ Page Title="" Language="C#" MasterPageFile="~/TPPD.Master" AutoEventWireup="true"
    CodeBehind="B_SalaryEFFECT1.aspx.cs" Inherits="TPPDDB._2_salary.B_SalaryEFFECT1" %>
            ...
            <table class="TableStyleBlue" style="width: 600px;">
                <tr>
                    ...
                    <td>
                        ...
                        <cc1:FilteredTextBoxExtender ID="txt_year_FilteredTextBoxExtender" runat="server"
                            Enabled="True" TargetControlID="txt_year" FilterType="Numbers">
                ...
                <tr id="trIDCARD" runat="server" visible="false">
                    ...
                    <td>
                        <asp:TextBox ID="TextBox_Group_MZ_ID_Data" runat="server" Height="19px" Visible="True"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td colspan="2" style="text-align: center;">
                        <asp:Button ID="btCreate" runat="server" OnClick="btCreate_Click" Text="產生考績獎金" 
