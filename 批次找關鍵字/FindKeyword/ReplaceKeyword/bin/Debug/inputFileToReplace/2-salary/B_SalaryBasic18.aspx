<%@ Page Title="" Language="C#" MasterPageFile="~/TPPD.Master" AutoEventWireup="true"
    CodeBehind="B_SalaryBasic18.aspx.cs" Inherits="TPPDDB._2_salary.B_SalaryBasic18" %>
            ...
            <asp:Panel ID="Panel_Search" runat="server" CssClass="DivPanel" Style="width: 770px;
                ...
                <table width="95%" class="TableStyleBlue">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="TextBox_BANK_ID" runat="server" Enabled="False" ReadOnly="True" MaxLength="16"></asp:TextBox>
                        </td>
                    </tr>
