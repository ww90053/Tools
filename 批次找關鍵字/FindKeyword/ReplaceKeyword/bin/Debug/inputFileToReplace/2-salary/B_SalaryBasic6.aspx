<%@ Page Title="" Language="C#" MasterPageFile="~/TPPD.Master" AutoEventWireup="true" CodeBehind="B_SalaryBasic6.aspx.cs" Inherits="TPPDDB._2_salary.B_SalaryBasic6" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Panel ID="Panel_WORKP" runat="server">
...
<table border="1" class="style1">
        ...
        <tr>
            <td colspan="4">
                <asp:GridView ID="GridView_WORKP" runat="server" AutoGenerateColumns="False" 
                    CellPadding="4" DataKeyNames="ID" DataSourceID="SqlDataSource_WORKP" 
                    GridLines="None" onrowcommand="GridView_WORKP_RowCommand" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="PAY" HeaderText="加給金額" SortExpression="PAY" DataFormatString="{0:$#,#0}" />
                ...
                <asp:SqlDataSource ID="SqlDataSource_WORKP" runat="server" 
                    ...
                    SelectCommand="SELECT ID, NAME, PAY, CREATEDATE FROM B_WORKP ORDER BY ID ASC">
                </asp:SqlDataSource>
            </td>
        </tr>
        <tr>
