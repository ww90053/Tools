<%@ Page Title="" Language="C#" MasterPageFile="~/TPPD.Master" AutoEventWireup="true" CodeBehind="B_SalaryToBank_back_compare.aspx.cs" Inherits="TPPDDB._2_salary.B_SalaryToBank_back_compare" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        ...
                        <td colspan="2">
                            <table width="100%">
                                <tr>
                                    ...
                                    <td style="text-align: center;">
                                        <asp:Button ID="btn_compare" runat="server" Text="回饋檔比較" 
                                            onclick="btn_compare_Click" />
                                    </td>
                                </tr>
            ...
            <Triggers>
                <asp:PostBackTrigger ControlID="btn_compare" />
            </Triggers>
        </asp:UpdatePanel>
